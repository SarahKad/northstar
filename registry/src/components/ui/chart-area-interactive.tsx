...
/** Small hatched SVG swatch for use in the legend, mirrors the area pattern. */
const HatchLegendIcon = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" style={{ display: "block" }}>
    ...
    <rect width="12" height="12" rx="1" fill="url(#legendHatchArea)" />
  </svg>
)
        ...
        >
          <AreaChart data={filteredData}>
            ...
            <Area
              dataKey="mobile"
              type="natural"
              fill={solidFill ? "url(#fillMobile)" : "url(#hatchMobileArea)"}
              stroke="var(--color-mobile)"
              stackId="a"
            />
            <Area
