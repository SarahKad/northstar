  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        description: "Stack content vertically or place media beside content.",
      },
      {
        name: "imagePosition",
        label: "Image",
        ...
        defaultValue: "none",
        description: "Optional image placement for the selected layout.",
      },
    ],
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: true,
        description: "Show the brand logo and app name in the sidebar header.",
      },
      {
        name: "showSearch",
        label: "Search bar",
        type: "boolean",
        defaultValue: true,
        description: "Show the search input in the sidebar header.",
      },
    ],
    doList: [
    ...
    props: [
      {
        ...
        label: "Current Step",
        type: "select",
        options: ["Not started", "Step 1", "Step 2", "Step 3", "All completed"],
        defaultValue: "Step 2",
        description: "Progress state — not started, in progress, or fully completed.",
      },
    ],
    doList: [
    ...
    props: [
      {
        ...
        options: ["2", "3", "4"],
        defaultValue: "3",
        description: "Number of top-level menus shown in the bar.",
      },
    ],
    doList: [
    ...
    props: [
      {
        ...
        type: "boolean",
        defaultValue: true,
        description: "Show the brand logo and name in the top nav.",
      },
      {
        name: "showSearch",
        label: "Search bar",
        type: "boolean",
        defaultValue: true,
        description: "Show the search input in the top nav actions area.",
      },
      {
        ...
        type: "boolean",
        defaultValue: true,
        description: "Show the breadcrumb trail in the top nav.",
      },
      {
        name: "breadcrumbLevels",
        label: "Breadcrumb levels",
        type: "select",
        options: ["1", "3"],
        defaultValue: "3",
        description: "Show a single current page or a three-level trail.",
      },
      {
        ...
        type: "text",
        defaultValue: "Button",
        description: "Current page label when using one breadcrumb level.",
      },
      {
        name: "breadcrumbTitle1",
        label: "Level 1 title",
        type: "text",
        defaultValue: "Home",
        description: "First breadcrumb label in a three-level trail.",
      },
      {
        name: "breadcrumbTitle2",
        label: "Level 2 title",
        type: "text",
        defaultValue: "Components",
        description: "Middle breadcrumb label in a three-level trail.",
      },
      {
        name: "breadcrumbTitle3",
        label: "Level 3 title",
        type: "text",
        defaultValue: "Button",
        description: "Current page label in a three-level trail.",
      },
    ],
    doList: [
    ...
    props: [
      {
        ...
        description: "Split panels side-by-side or stacked vertically.",
      },
    ],
    doList: [
